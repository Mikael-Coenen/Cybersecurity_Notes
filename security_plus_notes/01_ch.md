...
- Deterrent controls: seek to prevent an attacker from attempting to violate security policies, ex: barbed wire fences
...
- DLP systems work in two different environments: agent based and agentless (network-based)
